...
GUI 部分は PySide6 が必要だが、変換関数 (load/dump) は純 Python で動く。
"""
...
# ---------------------------------------------------------------------------
# GUI (PySide6) — import を遅延させてテスト時に Qt 不要にする
# ---------------------------------------------------------------------------
def _create_editor_window() -> type:
    """HospitalsEditorWindow クラスを返す (遅延 import)."""
    ...
    return HospitalsEditorWindow


def get_editor_class() -> type:
    """HospitalsEditorWindow クラスを取得する."""
